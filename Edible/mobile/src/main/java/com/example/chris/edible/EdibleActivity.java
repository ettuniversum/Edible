package com.example.chris.edible;

import info.edible.slidingmenu.fragment.HomeFragment;
import info.edible.slidingmenu.adapter.NavDrawerListAdapter;
import info.edible.slidingmenu.fragment.RestaurantFragment;
import info.edible.slidingmenu.model.NavDrawerItem;
...
public class EdibleActivity extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.edible, menu);
        return true;
    }
